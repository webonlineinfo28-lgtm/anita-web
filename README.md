...
Sala de fiestas social estilo **plug.dj** con sabor cósmico: **cabina de DJ con lista de espera y rotación**, **avatares procedenciales 100% editables**, **chat de sala con reacciones flotantes**, **bingo compartido** y **sistema de fama con niveles e insignias**.
...
│   ├── avatars.js          # avatares SVG procedenciales (testeable)
